...
$objPedido2 = new Pedido();
$query_cli2 = $objPedido2->GetComprobanteTipo($_GET["id"]);
...
$reg_total = $query_total->fetch_object();
 ...
 $V=new EnLetras();
 $con_letra=strtoupper($V->ValorEnLetras($reg_total->Total,"NUEVOS BOLIVIANOS"));
//$pdf->addCadreTVAs("---TRES MILLONES CUATROCIENTOS CINCUENTA Y UN MIL DOSCIENTOS CUARENTA BOLIVIANOS 00/100 M.N.");
